  ...
  return (
    <footer className="bg-zinc-950 border-t border-zinc-800/50 text-zinc-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-zinc-500 leading-relaxed mb-6">
              Tu tienda de ropa moderna con las últimas tendencias en moda urbana.
            </p>
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-zinc-800/80 flex items-center justify-center hover:bg-zinc-700 transition-colors text-zinc-400 hover:text-white"
              >
              ...
              <a
                href="https://wa.me/5493816488648"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-zinc-800/80 flex items-center justify-center hover:bg-zinc-700 transition-colors text-zinc-400 hover:text-white"
              >
        ...
        <div className="border-t border-zinc-800/50 mt-12 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-zinc-600">
