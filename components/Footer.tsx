      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-16">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
            ...
            {/* Tienda */}
            <div>
              <h4 className="text-white text-xs font-semibold uppercase tracking-widest mb-5">Tienda</h4>
            ...
            {/* Categorías */}
            <div>
              <h4 className="text-white text-xs font-semibold uppercase tracking-widest mb-5">Categorías</h4>
              <ul className="space-y-3">
                {categories.map((cat) => (
                  <li key={cat.id}>
            ...
            {/* Contacto */}
            <div>
              <h4 className="text-white text-xs font-semibold uppercase tracking-widest mb-5">Contacto</h4>
              <ul className="space-y-3 text-sm text-zinc-500">
                <li className="flex items-start gap-2.5">
                  ...
                  <span>clothstkbron@gmail.com</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <svg className="w-4 h-4 text-zinc-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span>+54 9 381 648 8648</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <svg className="w-4 h-4 text-zinc-600 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
